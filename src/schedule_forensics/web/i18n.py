...
_TERMS: dict[str, dict[str, str]] = {
    ...
    "One-Pager Compare": {
        "es": "Comparar cronogramas de una página",
        "fr": "Comparaison une page",
        "de": "Ein-Seiten-Vergleich",
        "pt": "Comparação de uma página",
    },
    "One-Pager compare": {
        "es": "Comparar cronogramas de una página",
        "fr": "Comparaison une page",
    ...
    "Per-swimlane summary": {
        "es": "Resumen por carril",
        "fr": "Résumé par couloir",
    ...
    "Swap prior and current": {
        ...
        "de": "Vorher und Aktuell tauschen",
        "pt": "Trocar anterior e atual",
    },
    "Clear both lists": {
        "es": "Borrar ambas listas",
        "fr": "Effacer les deux listes",
        "de": "Beide Listen löschen",
        "pt": "Limpar ambas as listas",
    },
    "How the two lists are matched": {
        "es": "Cómo se emparejan las dos listas",
        "fr": "Comment les deux listes sont appariées",
        "de": "Wie die beiden Listen zugeordnet werden",
        "pt": "Como as duas listas são emparelhadas",
    },
    "Prior list": {
        "es": "Lista anterior",
        "fr": "Liste précédente",

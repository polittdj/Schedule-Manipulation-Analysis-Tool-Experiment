...
count): <i>strict</i> discards that answer and <i>annotate</i> flags it. A digit that is also a genuine
value is untouched (collision-safe). <i>Interpretive</i> mode is not figure-gated at all. Read any

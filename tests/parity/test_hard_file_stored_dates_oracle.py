...
_LARGE = [
    # ADR-0491 re-measured: 1569 -> 1666 / 842 -> 865 / 1682 -> 1721 and 1589 -> 1687 / 1686
    # -> 1717 — the splits' chain heads (UID 5265 on both files: its only booking's daily
    # afternoon-only pattern, excluded from a 36.85-hour duration over a 15-day span) land exact
    ("fuse_ltf/Large_Test_File.mspdi.xml.gz", 1723, 1666, 865, 1022, 1721),
    ("fuse_ltf/Large_Test_File2.mspdi.xml.gz", 1722, 1687, 668, 936, 1717),
]

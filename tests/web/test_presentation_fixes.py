...
def test_no_mdash_entity_sentinel_values_remain_in_app_source() -> None:
    ...
    src = "".join(
        ...
        for p in (
            ...
            APP_SRC.with_name("onepager.py"),
            APP_SRC.with_name("onepager_compare.py"),
            APP_SRC.with_name("path.py"),
            APP_SRC.with_name("performance.py"),
            APP_SRC.with_name("portfolio.py"),
            APP_SRC.with_name("resources.py"),
            APP_SRC.with_name("risks.py"),
            APP_SRC.with_name("scorecards.py"),
            APP_SRC.with_name("scurve.py"),
            APP_SRC.with_name("sra.py"),
            APP_SRC.with_name("ssi.py"),
            APP_SRC.with_name("standards.py"),
            ...
            APP_SRC.with_name("curves.py"),
            APP_SRC.with_name("ribbon.py"),
            APP_SRC.with_name("volatility.py"),
            APP_SRC.with_name("workbench.py"),
            APP_SRC.with_name("settings.py"),
        )
    )

...
``tests/web/browser_chrome.py``, so a CI runner EXECUTES this module (ADR-0418) (same
posture as the other chromium modules — the runtime stays stdlib-only, Law 1).
"""

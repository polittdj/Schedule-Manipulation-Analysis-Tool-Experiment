...
| R-03 | **Missing golden inputs** — required `.pbix`/`.mpp`/Acumen/SSI/metrics-library files not deposited or incomplete. | Med | High | Gate-1 intake manifest with explicit checklist; verify presence/readability before Phase 1; gap list maintained in HANDOFF. | Open |

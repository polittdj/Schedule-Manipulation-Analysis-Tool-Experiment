...
**After the first CI read (2026-09-20):** the three Hard_File counterfactual pins re-derived +12 → +6 wd
(ADR-0513's consequence — nine QC-3 assumptions attacked, all held: 187 the only mover, its three-day
remaining on the team's 16-hour day, the aggregate's +0 explained), red on the pristine engine by name
and green here; `floor` / `test (3.11)`'s failures on `dc862dbf` were exactly those three.

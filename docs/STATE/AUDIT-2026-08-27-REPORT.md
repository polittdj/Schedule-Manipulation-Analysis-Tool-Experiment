...
multi-project oracle opened — Hard_File's resource-calendar CPM finish, the updated3 cost ledger,
...
| R-44 | T1 | Hard_File's CPM finish runs 42 days later than MS Project's stored finish (2026-12-17 vs 2026-11-05; Fuse's Project Finish is the stored one) — its resources sit on 16-hour and 24-hour calendars the base CPM does not model (ADR-0473) | OPEN | L | an assignment-calendar pass behind a flag: schedule a task on its assigned resource's calendar when one is assigned; measure against the four Hard_File snapshots' stored finishes (46331 / 46332 / 46368) | the CPM finish within one day of the stored finish on the four snapshots, the parity gate unmoved |

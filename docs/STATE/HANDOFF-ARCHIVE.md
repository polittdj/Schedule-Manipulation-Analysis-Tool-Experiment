...
# (prior) Handoff — 2026-08-02e (Phase 3 UI: /sra joins the panel contract — Act III complete; ADR-0339; v1.0.155)
...
# (prior) Handoff — 2026-08-02d (Phase 3 UI: /risks joins the panel contract; ADR-0338; v1.0.154)
...
# (prior) Handoff — 2026-08-02c (Phase 3 UI: chapter 12 joins the panel contract; ADR-0337; v1.0.153)
...
# (prior) Handoff — 2026-08-02b (a launch clears only what a killed run left behind; ADR-0336; v1.0.152)
...
# (prior) Handoff — 2026-08-02 (Phase 1b remainder: the disk cache empties itself on every quit; ADR-0335; v1.0.151)
...
# (prior) Handoff — 2026-08-01l (Phase 1b: the launcher claims the port before it serves; ADR-0334; v1.0.150)
...
# (prior) Handoff — 2026-08-01k (Phase 2: observers read records, telemetry probes on demand; ADR-0333; v1.0.149)
...
# (prior) Handoff — 2026-08-01j (Phase 1a: a wipe is total, by reflection; ADR-0332; v1.0.148)
...
# (prior) Handoff — 2026-08-01i (Phase 0: the caption halo + a pixel-measuring visual pass; ADR-0331; v1.0.147)
...
# (prior) Handoff — 2026-08-01h (batch 3c-ii: the on-demand SRA panels captioned — AXIS-TITLES COMPLETE; ADR-0330; v1.0.146)
...
# (prior) Handoff — 2026-08-01g (batch 3c-i: sra + volatility join the caption convention; ADR-0329; v1.0.145)
...
# (prior) Handoff — 2026-08-01f (PR-10 MERGED; the OR-04 collection kit banked; ADR-0328; v1.0.144)
...
# (prior) Handoff — 2026-08-01e (PR-10: OR-03 launch motion + the synthesized Boot Audio Hum; ADR-0328; v1.0.144)
...
# (prior) Handoff — 2026-08-01c (PR-9b: the Library pages wear the panel toolbar; ADR-0327; v1.0.143)
...
# (prior) Handoff — 2026-08-01b (PR-9a: one caption convention per medium — B1 shipped; ADR-0326; v1.0.142)
...
# (prior) Handoff — 2026-08-01 (PR-8: the margin dashboard joins the one caption convention; ADR-0325; v1.0.141)
...
# (prior) Handoff — 2026-07-31 (the base CPM honors per-task calendars; ADR-0324; v1.0.140)
...
# (prior) Handoff — 2026-07-31 (roll-up titles state the aggregation rule; ADR-0321; v1.0.139)
...
# (prior) Handoff — 2026-07-31 (the /evolution exports honor the page state; ADR-0320; v1.0.138)
...
# (prior) Handoff — 2026-07-31 (the /resources period labels yield to the measured caption; ADR-0319; v1.0.137)
...
# (prior) Handoff — 2026-07-31 (data-noprint finally hides in print: the C1 one-liner lands; ADR-0318; v1.0.136)
...
# (prior) Handoff — 2026-07-31 (one ⛶ per panel: the scatter adopts the /curves mechanism; ADR-0317; v1.0.135)
...
# (prior) Handoff — 2026-07-30 (the /performance first paint no longer races the chart frame; ADR-0316; v1.0.134)
...
# (prior) Handoff — 2026-07-30 (OR-04 shipped: the GPU is freed on exit in three tiers, and the three decisions are ANSWERED; ADR-0315; v1.0.133)
...
# (prior) Handoff — 2026-07-30 (OR-02 closed under audit: the callout dismisses and never covers the nav; ADR-0314; v1.0.132)
...
# (prior) Handoff — 2026-07-30 (#487 merged and verified; the three gating decisions are briefed; ADR-0313; v1.0.131)
...
# (prior) Handoff — 2026-07-30 (a number the operator never typed; ADR-0313; v1.0.131)
...
# (prior) Handoff — 2026-07-30 (the import anchor enforced; ADR-0312; v1.0.130)
...
# (prior) Handoff — 2026-07-30 (two time axes + rank 12 opened; ADR-0310, ADR-0311; v1.0.129)
...
# (prior) Handoff — 2026-07-29 (a guard that one code path can walk around; ADR-0308; v1.0.124)
...
# (prior) Handoff — 2026-07-29 (a ranking factor that does not change the uncertainty; ADR-0307; v1.0.123)
...
# (prior) Handoff — 2026-07-29 (an absent figure is not a zero; ADR-0306; v1.0.122)
...
# (prior) Handoff — 2026-07-29 (round 11 shipped; the ⛶ that finally moves; ADR-0305; v1.0.121)
...
# (prior) Handoff — 2026-07-28b (round 10 shipped; the toolbar that fired but did nothing; ADR-0304; v1.0.120)
...
# (prior) Handoff — 2026-07-28 (the Ultracode UI redesign: 9 rounds shipped; v1.0.119)
...
# (prior) Handoff — 2026-07-27l (the caption was never the problem; ADR-0303; v1.0.109)
...
# (prior) Handoff — 2026-07-27i (AXIS-TITLES batch 1: PENDING 16 -> 11; the spec's caption table is not a source; ADR-0301; v1.0.106)
...
# (prior) Handoff — 2026-07-27h (the windows CI leg now EXECUTES the symlink + drive-root shapes; ADR-0300 MERGED; v1.0.105)
...
# (prior) Handoff — 2026-07-27g (DOWNLOADER WORK COMPLETE AND MERGED; nothing in flight; v1.0.105)
...
# (prior) Handoff — 2026-07-27f (#446+#448 merged; a symlinked source was destroying the converter; v1.0.105)
...
# (prior) Handoff — 2026-07-27e (#446 MERGED; #447 superseded; a drive-root abort fixed; v1.0.105; highest ADR 0299)
...
# (prior) Handoff — 2026-07-27d (the downloader: one-file install now delivers .mpp, honestly; v1.0.105; highest ADR 0299)
...
# (prior) Handoff — 2026-07-27b (AXIS-TITLES batch 0: one caption convention; v1.0.104; highest ADR 0298)
...
# (prior) Handoff — 2026-07-27a (monolith split phase 1: state.py extracted; PERF BACKLOG CLEAR; v1.0.103; highest ADR 0297)
...
# (prior) Handoff — 2026-07-26a (dashboard status-UID payload trim SHIPPED; v1.0.102; highest ADR 0296)
...
# (prior) Handoff — 2026-07-25c (dashboard drill cross-project substitution FIXED; v1.0.101; highest ADR 0295)
...
# (prior) Handoff — 2026-07-25b (perf #6 CLOSED as a decision: importer left alone; highest ADR 0294)
...
# (prior) Handoff — 2026-07-25a (perf #5 MPP capability probe; v1.0.100; highest ADR 0293)
...
# (prior) Handoff — 2026-07-24h (perf #4 cache-tier byte budget: cpms BOUNDED; v1.0.99; highest ADR 0292)
...
# (prior) Handoff — 2026-07-24g (perf #3 manifest-projection memo; v1.0.98; highest ADR 0291)
...
# (prior) Handoff — 2026-07-24f (perf #2 bounded-concurrency pre-read; rename declined; v1.0.97; highest ADR 0290)
...
# (prior) Handoff — 2026-07-24e (perf backlog #1: lazy segment drill trims /api/trend ~46%; v1.0.96; highest ADR 0288)
...
# (prior) Handoff — 2026-07-24d (one tooltip + 1.5s hover-intent delay; Acumen parity ON by default; v1.0.95; highest ADR 0287)
...
# (prior) Handoff — 2026-07-24c (ADR-0282 resolved as Option A: findings/narrative/briefing follow the parity audit; v1.0.94; highest ADR 0285)
...
# (prior) Handoff — 2026-07-23b (validated multi-project performance fixes; byte-identical numbers; v1.0.91; highest ADR 0282)
...
# (prior) Handoff — 2026-07-23 (Acumen parity mode from the .aft — solves ALL DCMA parity; v1.0.90; highest ADR 0280)
...
>   lockstep. Branch `claude/conditional-branching-contingency-bi6g00` (restarted from merged main
>   2cc8f1e = v1.0.84 #420). PR #421 carried legend phase 3a (merged as 35182e4).
> - **NEXT: interactive legends phase 3b (bespoke).** `margin_dashboard.js` + `dashboard.js` are NOT
>   mechanical adoptions; `sra_grid.js` + `path_evolution.js` have no series to toggle → SKIPPED.

# (prior) Handoff — 2026-07-19i (interactive legends phase 2 — trend.js stacked/grouped; v1.0.84; highest ADR 0276)
...
# (prior) Handoff — 2026-07-19h (interactive legends phase 1 — SFLegend + trend charts; v1.0.83; highest ADR 0276)
...
# (prior) Handoff — 2026-07-19g (post-#417 audit hardening + Mission Control play/stop fix; v1.0.82; highest ADR 0275)
...
# (prior) Handoff — 2026-07-19f (conditional branching — #331 Hulett #9, the LAST non-deferred deck item; v1.0.81; highest ADR 0274)
...
# (prior) Handoff — 2026-07-19e (probabilistic-branching hardening per Codex review — #331 Hulett #8; v1.0.80; highest ADR 0273)
...
# (prior) Handoff — 2026-07-19d (ADR-0273: probabilistic branching — #331 Hulett #8, Opus Ultracode; v1.0.79; highest ADR 0273)

> ## STATUS — the #331 phase continued at Hulett #8: **probabilistic branching** — a discrete failure that inserts *rework* into the SSI Monte-Carlo in p% of iterations → the **bi-modal** finish the deterministic plan hides (ADR-0273). Unlike a risk (adds days to an EXISTING task), a branch is a NEW node on a chosen FS tie → participates in **merge bias** (only moves the finish when it drives). The augmentation mechanism was **verified against the real compute_cpm BEFORE any code** (`scratchpad/branch_verify.py`): a fragnet `after --FS0--> F --FS(lag)--> before` with F at 0 == base (byte-frozen). Engine (additive, `sra.py`): `ProbabilisticBranch` spec + `_augment_with_branches` (fragnet, 0 placeholder) + `compute_sra_ssi(branches=...)` toggling F's duration via `duration_overrides` + `_branch_draws` (disjoint firing/uniforms) + `SSIResult.branches` (SSIBranchStat, appended last, inert to the finish-cdf + ssi==jcl pins). SSI-only. Web: `SessionState.sra_branches`; POST /sra/branch; threaded into all 5 SSI sites; a "Probabilistic branches" editor + outcomes table; Save/Load persistence; i18n +2. Verified: 8 engine + 4 web tests + an end-to-end bimodal web check (Project5 tie 131→142). v1.0.78 → **1.0.79**, wheel + 9 installers. **Shipped as PR #415, MERGED.** Highest ADR **ADR-0273**.

# (prior) Handoff — 2026-07-19c (ADR-0272: risk-critical Gantt tint — #331 Hulett #12, Opus Ultracode; v1.0.78; highest ADR 0272)

> ## STATUS — the #331 phase continued at Hulett #12: the SSI schedule grid's Gantt bars tint by **Criticality Index** (how often each activity was critical across the last Monte-Carlo run) — the risk-critical view (ADR-0272). v1.0.77 → 1.0.78. **Premise correction caught by verify-everything BEFORE code:** SSIResult did NOT carry CI (compute_sra_ssi tallied `critical_counts` then DISCARDED it; CI lived only on the legacy compute_sra/SRAResult path). Fix = minimal ADDITIVE engine change: `SSIResult.criticality` (uid, fraction-critical; appended last, inert to the finish-cdf + ssi==jcl pins), `_build_ssi_result` takes `critical_counts`, `compute_sra_ssi` passes the counts it already tallies. Web: `SessionState.sra_criticality`/`_iters` cache the last run; `_ssi_grid_rows` adds per-row CI; `sra_grid.js` tints bars `g-ci-{0..4}` (risk-heat bands) behind a "tint by criticality" toggle with legend + provenance, as a ROW property (survives re-render); `sra_ssi.js` fires `sf-ssi-run` → grid reloads. Verified: +3 engine CI tests + grid/SSI web tests + a **four-theme CSP-strict browser check** (122 green / 4 red on Project5's rigid critical path). **Shipped as PR #414, MERGED.** Highest ADR **ADR-0272**.

# (prior) Handoff — 2026-07-19b (ADR-0271: Latin Hypercube sampling — #331 Hulett #11, Opus Ultracode; v1.0.77; highest ADR 0271)
...
>   mypy (116 files) + bandit clean. v1.0.76 → **1.0.77**, wheel + 9 installers in lockstep.
>   **Shipped as PR #411, MERGED** by the operator (CI 5/5 green).

# (prior) Handoff — 2026-07-19a (ADR-0270: correlation matrix + eigenvalue feasibility — #331 item 2, Opus Ultracode; v1.0.76; highest ADR 0270)
...
>   tests green; mypy clean (116 files).
...
>   #409; the #12 fix (v1.0.76) merged as #410.

# (prior) Handoff — 2026-07-18g (ADR-0269: JCL / FICSM joint cost-&-schedule confidence — the #331 phase opened on operator direction; v1.0.74; highest ADR 0269)
...
>   flipped to the live panel with the pinned honesty language kept verbatim. i18n catalog
>   +9 JCL terms in ES/FR/DE/PT.
> - **Verified:** tests/engine/test_jcl.py + tests/web/test_jcl_web.py; full gate green; LIVE
>   Chromium under the strict CSP (real POST form through the SEC-2 gate, all charts render,
>   zero console errors) — the sweep caught a real football x-axis label bug the DOM asserts
>   missed, fixed and re-verified. Parity untouched.
> - **State:** v1.0.74; **ADR-0269** highest; **PR #406 MERGED** (squash `ad10868`). Later:
>   #408 (JCL-through-real-MSPDI-import test) MERGED. Branch restarted clean each time.
> - **NEXT:** the #331 phase is OPEN with item 1 (JCL/FICSM) SHIPPED. Ranked next: #2
>   risk-driver correlation matrix + eigenvalue feasibility, then the STAT/GAO scorecard gap
>   audit. The three OWED operator inputs still block ADR-0261/0258 work.

# (prior) Handoff — 2026-07-18f (ADR-0268: strict script-src CSP + 4 residuals + a browser-surfaced SEC-2 correction; v1.0.73; highest ADR 0268)
...
# (prior) Handoff — 2026-07-18e (zero-margin SRA toggle ADR-0266 + roles i18n catalog ADR-0267 — the standing queue's last unblocked items; v1.0.72; highest ADR 0267)
...
# (prior) Handoff — 2026-07-18d (family-B basis unification ADR-0265: stepper/export/drill share one counterfactual basis; v1.0.71; highest ADR 0265)
...
# (prior) Handoff — 2026-07-18c (SEC-2/SEC-3 hardening ADR-0264: Host allowlist + Origin gate; v1.0.70; highest ADR 0264)
...
# (prior) Handoff — 2026-07-18b (full handoff-verification audit + remediation ADR-0262/0263: /mission tile degrade, epoch pairing, wipe finality, upload locking, summary-margin overlay; v1.0.69; highest ADR 0263)
...
# (prior) Handoff — 2026-07-18 (deep performance ADR-0261: epoch-keyed scope caches, CPM tier, census buckets, offload bounds; v1.0.68; highest ADR 0261)
...
# (prior) Handoff — 2026-07-18 (portfolio data-integrity: active-project scoping, hash dedup + review excludes, Company→Site; Gantt find coverage; v1.0.67; highest ADR 0260)
...
# (prior) Handoff — 2026-07-18 (operator UX pass: launcher self-diagnosis, Gantt visibility, +/- zoom, alphabetical group dropdowns, automate-crash guard; large-dataset role; v1.0.66; highest ADR 0257)
...
# (prior) Handoff — 2026-07-17 (session audit: margin-risk date realignment + hardening; v1.0.65; highest ADR 0256)
...
# (prior) Handoff — 2026-07-17 (F3c: user-parameterized NASA margin requirement rate; v1.0.62; highest ADR 0253)
...
# (prior) Handoff — 2026-07-17 (base-CPM single-calendar fail-soft disclosure, #26; v1.0.61; highest ADR 0252)
...
# (prior) Handoff — 2026-07-17 (ignore-toggle copy truth + page-family alignment, the ADR-0250 queued decision resolved; v1.0.60; highest ADR 0251)
...
# (prior) Handoff — 2026-07-17 (deep-audit remediation: CUI-log leak, DOM-XSS embed, cache lock, parity + fail-soft; v1.0.59; highest ADR 0250)
...
# (prior) Handoff — 2026-07-17 (audit-F: deterministic perf/memory-regression harness; v1.0.58; highest ADR 0249)
...
# (prior) Handoff — 2026-07-17 (PR-P1 safe increment: analysis-cache LRU, summary-edge guard, SRA finish-rank reuse; v1.0.58; highest ADR 0248)
...
# (prior) Handoff — 2026-07-17 (Audit remainder: driving-path per-task shading, xlsx zip-bomb cap, redact() spaced-path leak; v1.0.57; highest ADR 0247)
...
# (prior) Handoff — 2026-07-17 (Session-start ritual: auto-inject the live HANDOFF + archive history; v1.0.56; highest ADR 0246)
...
# (prior) Handoff — 2026-07-17 (Orchestrated audit + remediation: DOM-XSS BLOCKER, /cei fidelity, margin carry-forward, log redaction; v1.0.56; highest ADR 0245)

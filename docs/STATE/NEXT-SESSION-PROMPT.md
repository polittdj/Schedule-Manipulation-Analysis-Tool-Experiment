...
⇢ NEXT — **FIRST: #630's merge, then this PR's re-merge + installer rebuild (see the header).** THEN **WP6** (ledger highs: CPM-01 `cpm.py:1316` · CPM-02 `driving_slack.py:314` · MC-02 · MC-03

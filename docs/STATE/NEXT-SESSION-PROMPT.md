...
⇢ NEXT — **#631 merges when its CI is green (the #630 re-merge is DONE).** THEN **WP6** (ledger highs: CPM-01 `cpm.py:1316` · CPM-02 `driving_slack.py:314` · MC-02 · MC-03

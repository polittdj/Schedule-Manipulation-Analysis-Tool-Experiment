...
**PR state (2026-09-07 03:12Z): #645 MERGED → `main` @ `1f5b8f53` (tree-identical to its green head `2ebc53cd`; read `main`'s run #1767 first); this docs-only record rides a new draft PR (number in the SESSION-LOG follow-up) — merge it, then branch FRESH.**

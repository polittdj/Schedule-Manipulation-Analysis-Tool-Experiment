...
already in front of you). As of this file's last refresh that meant: `main` green at **v1.0.72**,
highest ADR **0267**, full gate green (ruff / ruff format --check / mypy --strict / bandit exit 0 /

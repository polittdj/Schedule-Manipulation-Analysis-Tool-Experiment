...
> **Version/ADR stamps refreshed 2026-07-17 (v1.0.66, ADR-0257; SEC-2/3 loopback Host allowlist + Origin gate).** For
...
### `docs/adr/` — 258 files (ADR-0000 through ADR-0257), no separate index

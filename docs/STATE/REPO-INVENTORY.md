...
> **Version/ADR stamps refreshed 2026-07-18 (v1.0.69, ADR-0263; handoff-verification audit + remediation).** For
...
### `docs/adr/` — 257 files (ADR-0000 through ADR-0256), no separate index

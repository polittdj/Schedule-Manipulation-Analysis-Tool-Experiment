...
## §7 — QC/PM regime
TDD + pytest (**612 passed, 3 skipped**); coverage gates **engine ≥85% (≈98%), overall ≥70% (≈98%)**;
...
with PRs (#55–#71 merged to `main`: build, two audit remediations, no-admin Java discovery, data-date

...
| Insufficient Detail™ | **43 exact** (ADR-0084) — adopted the library's Bible formula `OriginalDuration_workdays / (ProjectFinish − ProjectStart)_days > 0.1` (current duration / project calendar span). Operator-approved; re-pinned TP3 8→9 and Project5 1→0 (the older captures predate this library). |
